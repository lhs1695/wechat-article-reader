...
| [设计动机与经历](docs/设计动机与经历.md) | 为什么做成阅读服务、做过哪些收缩 |
| [MCP 构建设计](docs/MCP构建设计与面试讲述.md) | 工具契约、副作用拆分、长文策略 |
| [演进与升级](docs/演进与升级.md) | 可以怎么优化、什么不该加 |
| [阶段性总结](docs/阶段性总结.md) | 收敛记录与使用建议 |

贡献与协作约定见 [AGENTS.md](AGENTS.md)。License：MIT。
